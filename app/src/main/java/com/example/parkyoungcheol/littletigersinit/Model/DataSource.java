...
public class DataSource {
    ...
    public static String createRequestCategoryURL(String source, double lon, double lat, double subDistance) {
        String ret = "";    // 결과 스트링
        ...
        switch (source) {
            ...
            // 네이버 웹페이지에서 가져오는 정보임
            case "CAFE":
                ret = "http://map.naver.com/search2/interestSpot.nhn?type=CAFE&boundary=" + Double.toString(lon - subDistance) + "%3B" +
                        Double.toString(lat - subDistance) + "%3B" + Double.toString(lon + subDistance) +
                        "%3B" + Double.toString(lat + subDistance) + "&pageSize=5";
                break;

            case "BUSSTOP": // 버스 정류장
                ret = "http://map.naver.com/search2/searchBusStopWithinRectangle.nhn?bounds=" + Double.toString(lon - subDistance) + "%3B" +
                        Double.toString(lat - subDistance) + "%3B" + Double.toString(lon + subDistance) + "%3B"
                        + Double.toString(lat + subDistance) + "&count=100&level10";
                break;

            case "CONVENIENCE": // 편의점
                ret = "http://map.naver.com/search2/interestSpot.nhn?type=STORE&boundary=" + Double.toString(lon - subDistance) + "%3B" +
                        Double.toString(lat - subDistance) + "%3B" + Double.toString(lon + subDistance) +
                        "%3B" + Double.toString(lat + subDistance) + "&pageSize=5";
                break;

            case "RESTAURANT": //식당
                ret = "http://map.naver.com/search2/interestSpot.nhn?type=DINING_KOREAN&boundary=" + Double.toString(lon - subDistance) + "%3B" +
                        Double.toString(lat - subDistance) + "%3B" + Double.toString(lon + subDistance) +
                        "%3B" + Double.toString(lat + subDistance) + "&pageSize=5";
                break;
            ...
            case "BANK": //은행
                ret = "http://map.naver.com/search2/interestSpot.nhn?type=BANK&boundary=" + Double.toString(lon - subDistance) + "%3B" +
                        Double.toString(lat - subDistance) + "%3B" + Double.toString(lon + subDistance) +
                        "%3B" + Double.toString(lat + subDistance) + "&pageSize=5";
                break;

            case "ACCOMMODATION":
                ret = "http://map.naver.com/search2/interestSpot.nhn?type=ACCOMMODATION&boundary=" + Double.toString(lon - subDistance) + "%3B" +
                        Double.toString(lat - subDistance) + "%3B" + Double.toString(lon + subDistance) +
                        "%3B" + Double.toString(lat + subDistance) + "&pageSize=5";
                break;

            case "HOSPITAL":
                ret = "http://map.naver.com/search2/interestSpot.nhn?type=HOSPITAL&boundary=" + Double.toString(lon - subDistance) + "%3B" +
                        Double.toString(lat - subDistance) + "%3B" + Double.toString(lon + subDistance) +
                        "%3B" + Double.toString(lat + subDistance) + "&pageSize=5";
                break;
        }
